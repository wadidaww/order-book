...
public:
    ...
    [[nodiscard]] bool addOrder(OrderId id, Price price, Quantity quantity, 
    ...
    void setOrderUpdateCallback(OrderUpdateCallback callback) { orderUpdateCallback_ = std::move(callback); }
